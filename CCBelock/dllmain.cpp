...
{//
	...
	{ 
		...
		case DLL_PROCESS_ATTACH:
			...
			LOG(WARNING)<<"JINCHU ELOCK DLL_PROCESS_ATTACH"<<endl;
			break;
		case DLL_THREAD_ATTACH:
			OutputDebugStringA("JINCHU ELOCK DLL_THREAD_ATTACH");
			LOG(WARNING)<<"JINCHU ELOCK DLL_THREAD_ATTACH"<<endl;
			break;
		case DLL_THREAD_DETACH:
			OutputDebugStringA("JINCHU ELOCK DLL_THREAD_DETACH");
			LOG(WARNING)<<"JINCHU ELOCK DLL_THREAD_DETACH"<<endl;
			break;
		case DLL_PROCESS_DETACH:
			OutputDebugStringA("JINCHU ELOCK DLL_PROCESS_DETACH");
			LOG(WARNING)<<"JINCHU ELOCK DLL_PROCESS_DETACH"<<endl;
			break;
		}
